...
typedef struct {
  ...
  void *data2;
	...
	if(offsetof(struct SDL_RWops, size) >= 0) swigFunctionPointer( "c-funptr SDL_RWops-size() {((struct SDL_RWops*)ptr)->size} a -- d", "", "", "	( context -- )" );
	if(offsetof(struct SDL_RWops, seek) >= 0) swigFunctionPointer( "c-funptr SDL_RWops-seek() {((struct SDL_RWops*)ptr)->seek} a d n -- d", "", "", "	( context offset whence -- )" );
	if(offsetof(struct SDL_RWops, read) >= 0) swigFunctionPointer( "c-funptr SDL_RWops-read() {((struct SDL_RWops*)ptr)->read} a a u u -- u", "", "", "	( context ptr size maxnum -- )" );
	if(offsetof(struct SDL_RWops, write) >= 0) swigFunctionPointer( "c-funptr SDL_RWops-write() {((struct SDL_RWops*)ptr)->write} a a u u -- u", "", "", "	( context ptr size num -- )" );
	if(offsetof(struct SDL_RWops, close) >= 0) swigFunctionPointer( "c-funptr SDL_RWops-close() {((struct SDL_RWops*)ptr)->close} a -- n", "", "", "	( context -- )" );
