...
// 	printf( "drop %zu end-structure\n", sizeof( _VAConfigAttribValMultipleFrame_bits ) );
	...
	swigComment("VAConfigAttribValContextPriority\n");
...
// 	printf( "drop %zu end-structure\n", sizeof( _VAConfigAttribValContextPriority_bits ) );
	...
	swigComment("VAContextParameterUpdateBuffer\n");
...
// // 	printf( "drop %zu end-structure\n", sizeof( _VAEncSliceParameterBuffer_slice_flags_bits ) );
	...
	swigComment("VADisplayAttribValSubDevice\n");
...
// 	if(offsetof(struct VADriverVTable, vaTerminate) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaTerminate() {((struct VADriverVTable*)ptr)->vaTerminate} a -- n", "", "", "	( ctx -- )" );
// 	if(offsetof(struct VADriverVTable, vaQueryConfigProfiles) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaQueryConfigProfiles() {((struct VADriverVTable*)ptr)->vaQueryConfigProfiles} a a a -- n", "", "", "	( ctx profile_list num_profiles -- )" );
// 	if(offsetof(struct VADriverVTable, vaQueryConfigEntrypoints) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaQueryConfigEntrypoints() {((struct VADriverVTable*)ptr)->vaQueryConfigEntrypoints} a n a a -- n", "", "", "	( ctx profile entrypoint_list num_entrypoints -- )" );
// 	if(offsetof(struct VADriverVTable, vaGetConfigAttributes) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaGetConfigAttributes() {((struct VADriverVTable*)ptr)->vaGetConfigAttributes} a n n a n -- n", "", "", "	( ctx profile entrypoint attrib_list num_attribs -- )" );
// 	if(offsetof(struct VADriverVTable, vaCreateConfig) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaCreateConfig() {((struct VADriverVTable*)ptr)->vaCreateConfig} a n n a n a -- n", "", "", "	( ctx profile entrypoint attrib_list num_attribs config_id -- )" );
// 	if(offsetof(struct VADriverVTable, vaDestroyConfig) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaDestroyConfig() {((struct VADriverVTable*)ptr)->vaDestroyConfig} a u -- n", "", "", "	( ctx config_id -- )" );
// 	if(offsetof(struct VADriverVTable, vaQueryConfigAttributes) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaQueryConfigAttributes() {((struct VADriverVTable*)ptr)->vaQueryConfigAttributes} a u a a a a -- n", "", "", "	( ctx config_id profile entrypoint attrib_list num_attribs -- )" );
// 	if(offsetof(struct VADriverVTable, vaCreateSurfaces) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaCreateSurfaces() {((struct VADriverVTable*)ptr)->vaCreateSurfaces} a n n n n a -- n", "", "", "	( ctx width height format num_surfaces surfaces -- )" );
// 	if(offsetof(struct VADriverVTable, vaDestroySurfaces) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaDestroySurfaces() {((struct VADriverVTable*)ptr)->vaDestroySurfaces} a a n -- n", "", "", "	( ctx surface_list num_surfaces -- )" );
// 	if(offsetof(struct VADriverVTable, vaCreateContext) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaCreateContext() {((struct VADriverVTable*)ptr)->vaCreateContext} a u n n n a n a -- n", "", "", "	( ctx config_id picture_width picture_height flag render_targets num_render_targets context -- )" );
// 	if(offsetof(struct VADriverVTable, vaDestroyContext) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaDestroyContext() {((struct VADriverVTable*)ptr)->vaDestroyContext} a u -- n", "", "", "	( ctx context -- )" );
// 	if(offsetof(struct VADriverVTable, vaCreateBuffer) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaCreateBuffer() {((struct VADriverVTable*)ptr)->vaCreateBuffer} a u n u u a a -- n", "", "", "	( ctx context type size num_elements data buf_id -- )" );
// 	if(offsetof(struct VADriverVTable, vaBufferSetNumElements) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaBufferSetNumElements() {((struct VADriverVTable*)ptr)->vaBufferSetNumElements} a u u -- n", "", "", "	( ctx buf_id num_elements -- )" );
// 	if(offsetof(struct VADriverVTable, vaMapBuffer) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaMapBuffer() {((struct VADriverVTable*)ptr)->vaMapBuffer} a u a -- n", "", "", "	( ctx buf_id pbuf -- )" );
// 	if(offsetof(struct VADriverVTable, vaUnmapBuffer) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaUnmapBuffer() {((struct VADriverVTable*)ptr)->vaUnmapBuffer} a u -- n", "", "", "	( ctx buf_id -- )" );
// 	if(offsetof(struct VADriverVTable, vaDestroyBuffer) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaDestroyBuffer() {((struct VADriverVTable*)ptr)->vaDestroyBuffer} a u -- n", "", "", "	( ctx buffer_id -- )" );
// 	if(offsetof(struct VADriverVTable, vaBeginPicture) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaBeginPicture() {((struct VADriverVTable*)ptr)->vaBeginPicture} a u u -- n", "", "", "	( ctx context render_target -- )" );
// 	if(offsetof(struct VADriverVTable, vaRenderPicture) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaRenderPicture() {((struct VADriverVTable*)ptr)->vaRenderPicture} a u a n -- n", "", "", "	( ctx context buffers num_buffers -- )" );
// 	if(offsetof(struct VADriverVTable, vaEndPicture) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaEndPicture() {((struct VADriverVTable*)ptr)->vaEndPicture} a u -- n", "", "", "	( ctx context -- )" );
// 	if(offsetof(struct VADriverVTable, vaSyncSurface) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaSyncSurface() {((struct VADriverVTable*)ptr)->vaSyncSurface} a u -- n", "", "", "	( ctx render_target -- )" );
// 	if(offsetof(struct VADriverVTable, vaQuerySurfaceStatus) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaQuerySurfaceStatus() {((struct VADriverVTable*)ptr)->vaQuerySurfaceStatus} a u a -- n", "", "", "	( ctx render_target status -- )" );
// 	if(offsetof(struct VADriverVTable, vaQuerySurfaceError) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaQuerySurfaceError() {((struct VADriverVTable*)ptr)->vaQuerySurfaceError} a u n a -- n", "", "", "	( ctx render_target error_status error_info -- )" );
// 	if(offsetof(struct VADriverVTable, vaPutSurface) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaPutSurface() {((struct VADriverVTable*)ptr)->vaPutSurface} a u a n n u u n n u u a u u -- n", "", "", "	( ctx surface draw srcx srcy srcw srch destx desty destw desth cliprects number_cliprects flags -- )" );
// 	if(offsetof(struct VADriverVTable, vaQueryImageFormats) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaQueryImageFormats() {((struct VADriverVTable*)ptr)->vaQueryImageFormats} a a a -- n", "", "", "	( ctx format_list num_formats -- )" );
// 	if(offsetof(struct VADriverVTable, vaCreateImage) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaCreateImage() {((struct VADriverVTable*)ptr)->vaCreateImage} a a n n a -- n", "", "", "	( ctx format width height image -- )" );
// 	if(offsetof(struct VADriverVTable, vaDeriveImage) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaDeriveImage() {((struct VADriverVTable*)ptr)->vaDeriveImage} a u a -- n", "", "", "	( ctx surface image -- )" );
// 	if(offsetof(struct VADriverVTable, vaDestroyImage) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaDestroyImage() {((struct VADriverVTable*)ptr)->vaDestroyImage} a u -- n", "", "", "	( ctx image -- )" );
// 	if(offsetof(struct VADriverVTable, vaSetImagePalette) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaSetImagePalette() {((struct VADriverVTable*)ptr)->vaSetImagePalette} a u a -- n", "", "", "	( ctx image palette -- )" );
// 	if(offsetof(struct VADriverVTable, vaGetImage) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaGetImage() {((struct VADriverVTable*)ptr)->vaGetImage} a u n n u u u -- n", "", "", "	( ctx surface x y width height image -- )" );
// 	if(offsetof(struct VADriverVTable, vaPutImage) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaPutImage() {((struct VADriverVTable*)ptr)->vaPutImage} a u u n n u u n n u u -- n", "", "", "	( ctx surface image src_x src_y src_width src_height dest_x dest_y dest_width dest_height -- )" );
// 	if(offsetof(struct VADriverVTable, vaQuerySubpictureFormats) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaQuerySubpictureFormats() {((struct VADriverVTable*)ptr)->vaQuerySubpictureFormats} a a a a -- n", "", "", "	( ctx format_list flags num_formats -- )" );
// 	if(offsetof(struct VADriverVTable, vaCreateSubpicture) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaCreateSubpicture() {((struct VADriverVTable*)ptr)->vaCreateSubpicture} a u a -- n", "", "", "	( ctx image subpicture -- )" );
// 	if(offsetof(struct VADriverVTable, vaDestroySubpicture) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaDestroySubpicture() {((struct VADriverVTable*)ptr)->vaDestroySubpicture} a u -- n", "", "", "	( ctx subpicture -- )" );
// 	if(offsetof(struct VADriverVTable, vaSetSubpictureImage) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaSetSubpictureImage() {((struct VADriverVTable*)ptr)->vaSetSubpictureImage} a u u -- n", "", "", "	( ctx subpicture image -- )" );
// 	if(offsetof(struct VADriverVTable, vaSetSubpictureChromakey) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaSetSubpictureChromakey() {((struct VADriverVTable*)ptr)->vaSetSubpictureChromakey} a u u u u -- n", "", "", "	( ctx subpicture chromakey_min chromakey_max chromakey_mask -- )" );
// 	if(offsetof(struct VADriverVTable, vaSetSubpictureGlobalAlpha) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaSetSubpictureGlobalAlpha() {((struct VADriverVTable*)ptr)->vaSetSubpictureGlobalAlpha} a u r -- n", "", "", "	( ctx subpicture global_alpha -- )" );
// 	if(offsetof(struct VADriverVTable, vaAssociateSubpicture) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaAssociateSubpicture() {((struct VADriverVTable*)ptr)->vaAssociateSubpicture} a u a n n n u u n n u u u -- n", "", "", "	( ctx subpicture target_surfaces num_surfaces src_x src_y src_width src_height dest_x dest_y dest_width dest_height flags -- )" );
// 	if(offsetof(struct VADriverVTable, vaDeassociateSubpicture) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaDeassociateSubpicture() {((struct VADriverVTable*)ptr)->vaDeassociateSubpicture} a u a n -- n", "", "", "	( ctx subpicture target_surfaces num_surfaces -- )" );
// 	if(offsetof(struct VADriverVTable, vaQueryDisplayAttributes) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaQueryDisplayAttributes() {((struct VADriverVTable*)ptr)->vaQueryDisplayAttributes} a a a -- n", "", "", "	( ctx attr_list num_attributes -- )" );
// 	if(offsetof(struct VADriverVTable, vaGetDisplayAttributes) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaGetDisplayAttributes() {((struct VADriverVTable*)ptr)->vaGetDisplayAttributes} a a n -- n", "", "", "	( ctx attr_list num_attributes -- )" );
// 	if(offsetof(struct VADriverVTable, vaSetDisplayAttributes) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaSetDisplayAttributes() {((struct VADriverVTable*)ptr)->vaSetDisplayAttributes} a a n -- n", "", "", "	( ctx attr_list num_attributes -- )" );
// 	if(offsetof(struct VADriverVTable, vaBufferInfo) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaBufferInfo() {((struct VADriverVTable*)ptr)->vaBufferInfo} a u a a a -- n", "", "", "	( ctx buf_id type size num_elements -- )" );
// 	if(offsetof(struct VADriverVTable, vaLockSurface) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaLockSurface() {((struct VADriverVTable*)ptr)->vaLockSurface} a u a a a a a a a a a -- n", "", "", "	( ctx surface fourcc luma_stride chroma_u_stride chroma_v_stride luma_offset chroma_u_offset chroma_v_offset buffer_name buffer -- )" );
// 	if(offsetof(struct VADriverVTable, vaUnlockSurface) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaUnlockSurface() {((struct VADriverVTable*)ptr)->vaUnlockSurface} a u -- n", "", "", "	( ctx surface -- )" );
// 	if(offsetof(struct VADriverVTable, vaGetSurfaceAttributes) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaGetSurfaceAttributes() {((struct VADriverVTable*)ptr)->vaGetSurfaceAttributes} a u a u -- n", "", "", "	( dpy config attrib_list num_attribs -- )" );
// 	if(offsetof(struct VADriverVTable, vaCreateSurfaces2) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaCreateSurfaces2() {((struct VADriverVTable*)ptr)->vaCreateSurfaces2} a u u u a u a u -- n", "", "", "	( ctx format width height surfaces num_surfaces attrib_list num_attribs -- )" );
// 	if(offsetof(struct VADriverVTable, vaQuerySurfaceAttributes) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaQuerySurfaceAttributes() {((struct VADriverVTable*)ptr)->vaQuerySurfaceAttributes} a u a a -- n", "", "", "	( dpy config attrib_list num_attribs -- )" );
// 	if(offsetof(struct VADriverVTable, vaAcquireBufferHandle) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaAcquireBufferHandle() {((struct VADriverVTable*)ptr)->vaAcquireBufferHandle} a u a -- n", "", "", "	( ctx buf_id buf_info -- )" );
// 	if(offsetof(struct VADriverVTable, vaReleaseBufferHandle) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaReleaseBufferHandle() {((struct VADriverVTable*)ptr)->vaReleaseBufferHandle} a u -- n", "", "", "	( ctx buf_id -- )" );
// 	if(offsetof(struct VADriverVTable, vaCreateMFContext) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaCreateMFContext() {((struct VADriverVTable*)ptr)->vaCreateMFContext} a a -- n", "", "", "	( ctx mfe_context -- )" );
// 	if(offsetof(struct VADriverVTable, vaMFAddContext) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaMFAddContext() {((struct VADriverVTable*)ptr)->vaMFAddContext} a u u -- n", "", "", "	( ctx mf_context context -- )" );
// 	if(offsetof(struct VADriverVTable, vaMFReleaseContext) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaMFReleaseContext() {((struct VADriverVTable*)ptr)->vaMFReleaseContext} a u u -- n", "", "", "	( ctx mf_context context -- )" );
// 	if(offsetof(struct VADriverVTable, vaMFSubmit) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaMFSubmit() {((struct VADriverVTable*)ptr)->vaMFSubmit} a u a n -- n", "", "", "	( ctx mf_context contexts num_contexts -- )" );
// 	if(offsetof(struct VADriverVTable, vaCreateBuffer2) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaCreateBuffer2() {((struct VADriverVTable*)ptr)->vaCreateBuffer2} a u n u u a a a -- n", "", "", "	( ctx context type width height unit_size pitch buf_id -- )" );
// 	if(offsetof(struct VADriverVTable, vaQueryProcessingRate) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaQueryProcessingRate() {((struct VADriverVTable*)ptr)->vaQueryProcessingRate} a u a a -- n", "", "", "	( ctx config_id proc_buf processing_rate -- )" );
// 	if(offsetof(struct VADriverVTable, vaExportSurfaceHandle) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaExportSurfaceHandle() {((struct VADriverVTable*)ptr)->vaExportSurfaceHandle} a u u u a -- n", "", "", "	( ctx surface_id mem_type flags descriptor -- )" );
// 	if(offsetof(struct VADriverVTable, vaSyncSurface2) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaSyncSurface2() {((struct VADriverVTable*)ptr)->vaSyncSurface2} a u n -- n", "", "", "	( ctx surface timeout_ns -- )" );
// 	if(offsetof(struct VADriverVTable, vaSyncBuffer) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaSyncBuffer() {((struct VADriverVTable*)ptr)->vaSyncBuffer} a u n -- n", "", "", "	( ctx buf_id timeout_ns -- )" );
// 	if(offsetof(struct VADriverVTable, vaCopy) >= 0) swigFunctionPointer( "c-funptr VADriverVTable-vaCopy() {((struct VADriverVTable*)ptr)->vaCopy} a a a a{*(VACopyOption*)} -- n", "", "", "	( ctx dst src option -- )" );
	if(offsetof(struct VADriverContext, error_callback) >= 0) swigFunctionPointer( "c-funptr VADriverContext-error_callback() {((struct VADriverContext*)ptr)->error_callback} a s -- void", "", "", "	( pDriverContext message -- )" );
	if(offsetof(struct VADriverContext, info_callback) >= 0) swigFunctionPointer( "c-funptr VADriverContext-info_callback() {((struct VADriverContext*)ptr)->info_callback} a s -- void", "", "", "	( pDriverContext message -- )" );
	if(offsetof(struct VADisplayContext, vaIsValid) >= 0) swigFunctionPointer( "c-funptr VADisplayContext-vaIsValid() {((struct VADisplayContext*)ptr)->vaIsValid} a -- n", "", "", "	( ctx -- )" );
	if(offsetof(struct VADisplayContext, vaDestroy) >= 0) swigFunctionPointer( "c-funptr VADisplayContext-vaDestroy() {((struct VADisplayContext*)ptr)->vaDestroy} a -- void", "", "", "	( ctx -- )" );
	if(offsetof(struct VADisplayContext, vaGetDriverName) >= 0) swigFunctionPointer( "c-funptr VADisplayContext-vaGetDriverName() {((struct VADisplayContext*)ptr)->vaGetDriverName} a a -- n", "", "", "	( ctx driver_name -- )" );
	if(offsetof(struct VADisplayContext, vaGetNumCandidates) >= 0) swigFunctionPointer( "c-funptr VADisplayContext-vaGetNumCandidates() {((struct VADisplayContext*)ptr)->vaGetNumCandidates} a a -- n", "", "", "	( ctx num_candidates -- )" );
	if(offsetof(struct VADisplayContext, vaGetDriverNameByIndex) >= 0) swigFunctionPointer( "c-funptr VADisplayContext-vaGetDriverNameByIndex() {((struct VADisplayContext*)ptr)->vaGetDriverNameByIndex} a a n -- n", "", "", "	( ctx driver_name candidate_index -- )" );
// 	if(offsetof(struct VADriverVTableWayland, vaGetSurfaceBufferWl) >= 0) swigFunctionPointer( "c-funptr VADriverVTableWayland-vaGetSurfaceBufferWl() {((struct VADriverVTableWayland*)ptr)->vaGetSurfaceBufferWl} a u u a -- n", "", "", "	( ctx surface flags out_buffer -- )" );
// 	if(offsetof(struct VADriverVTableWayland, vaGetImageBufferWl) >= 0) swigFunctionPointer( "c-funptr VADriverVTableWayland-vaGetImageBufferWl() {((struct VADriverVTableWayland*)ptr)->vaGetImageBufferWl} a u u a -- n", "", "", "	( ctx image flags out_buffer -- )" );
// 	if(offsetof(struct VADriverVTableGLX, vaCreateSurfaceGLX) >= 0) swigFunctionPointer( "c-funptr VADriverVTableGLX-vaCreateSurfaceGLX() {((struct VADriverVTableGLX*)ptr)->vaCreateSurfaceGLX} a u u a -- n", "", "", "	( ctx gl_target gl_texture gl_surface -- )" );
// 	if(offsetof(struct VADriverVTableGLX, vaDestroySurfaceGLX) >= 0) swigFunctionPointer( "c-funptr VADriverVTableGLX-vaDestroySurfaceGLX() {((struct VADriverVTableGLX*)ptr)->vaDestroySurfaceGLX} a a -- n", "", "", "	( ctx gl_surface -- )" );
// 	if(offsetof(struct VADriverVTableGLX, vaCopySurfaceGLX) >= 0) swigFunctionPointer( "c-funptr VADriverVTableGLX-vaCopySurfaceGLX() {((struct VADriverVTableGLX*)ptr)->vaCopySurfaceGLX} a a u u -- n", "", "", "	( ctx gl_surface surface flags -- )" );
// 	if(offsetof(struct VADriverVTableVPP, vaQueryVideoProcFilters) >= 0) swigFunctionPointer( "c-funptr VADriverVTableVPP-vaQueryVideoProcFilters() {((struct VADriverVTableVPP*)ptr)->vaQueryVideoProcFilters} a u a a -- n", "", "", "	( ctx context filters num_filters -- )" );
// 	if(offsetof(struct VADriverVTableVPP, vaQueryVideoProcFilterCaps) >= 0) swigFunctionPointer( "c-funptr VADriverVTableVPP-vaQueryVideoProcFilterCaps() {((struct VADriverVTableVPP*)ptr)->vaQueryVideoProcFilterCaps} a u n a a -- n", "", "", "	( ctx context type filter_caps num_filter_caps -- )" );
// 	if(offsetof(struct VADriverVTableVPP, vaQueryVideoProcPipelineCaps) >= 0) swigFunctionPointer( "c-funptr VADriverVTableVPP-vaQueryVideoProcPipelineCaps() {((struct VADriverVTableVPP*)ptr)->vaQueryVideoProcPipelineCaps} a u a u a -- n", "", "", "	( ctx context filters num_filters pipeline_caps -- )" );
	...
	swigFunction( "c-function vaSyncSurface2 vaSyncSurface2 a u n -- n", "FUNCTION: vaSyncSurface2 ( dpy surface timeout_ns -- n )", "EXTERN: \"C\" int vaSyncSurface2( void * dpy, int surface, n timeout_ns );", "	( dpy surface timeout_ns -- )" );
	...
	swigFunction( "c-function vaSyncBuffer vaSyncBuffer a u n -- n", "FUNCTION: vaSyncBuffer ( dpy buf_id timeout_ns -- n )", "EXTERN: \"C\" int vaSyncBuffer( void * dpy, int buf_id, n timeout_ns );", "	( dpy buf_id timeout_ns -- )" );
