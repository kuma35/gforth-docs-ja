...
int main( int argc, char **argv )
{
	...
	#endif
	#ifdef PNG_DISPOSE_OP_NONE
		swigUnsignedIntConstant( PNG_DISPOSE_OP_NONE, "PNG_DISPOSE_OP_NONE" );
	#endif
	#ifdef PNG_DISPOSE_OP_BACKGROUND
		swigUnsignedIntConstant( PNG_DISPOSE_OP_BACKGROUND, "PNG_DISPOSE_OP_BACKGROUND" );
	#endif
	#ifdef PNG_DISPOSE_OP_PREVIOUS
		swigUnsignedIntConstant( PNG_DISPOSE_OP_PREVIOUS, "PNG_DISPOSE_OP_PREVIOUS" );
	#endif
	#ifdef PNG_BLEND_OP_SOURCE
		swigUnsignedIntConstant( PNG_BLEND_OP_SOURCE, "PNG_BLEND_OP_SOURCE" );
	#endif
	#ifdef PNG_BLEND_OP_OVER
		swigUnsignedIntConstant( PNG_BLEND_OP_OVER, "PNG_BLEND_OP_OVER" );
	#endif
	...
	#endif
	#ifdef PNG_INFO_acTL
		swigUnsignedIntConstant( PNG_INFO_acTL, "PNG_INFO_acTL" );
	#endif
	#ifdef PNG_INFO_fcTL
		swigUnsignedIntConstant( PNG_INFO_fcTL, "PNG_INFO_fcTL" );
	#endif
	...
	swigFunction( "c-function png_get_acTL png_get_acTL a a a a -- u", "FUNCTION: png_get_acTL ( png_ptr info_ptr num_frames num_plays -- u )", "EXTERN: \"C\" int png_get_acTL( void * png_ptr, void * info_ptr, void * num_frames, void * num_plays );", "	( png_ptr info_ptr num_frames num_plays -- )" );
	swigFunction( "c-function png_set_acTL png_set_acTL a a u u -- u", "FUNCTION: png_set_acTL ( png_ptr info_ptr num_frames num_plays -- u )", "EXTERN: \"C\" int png_set_acTL( void * png_ptr, void * info_ptr, int num_frames, int num_plays );", "	( png_ptr info_ptr num_frames num_plays -- )" );
	swigFunction( "c-function png_get_num_frames png_get_num_frames a a -- u", "FUNCTION: png_get_num_frames ( png_ptr info_ptr -- u )", "EXTERN: \"C\" int png_get_num_frames( void * png_ptr, void * info_ptr );", "	( png_ptr info_ptr -- )" );
	swigFunction( "c-function png_get_num_plays png_get_num_plays a a -- u", "FUNCTION: png_get_num_plays ( png_ptr info_ptr -- u )", "EXTERN: \"C\" int png_get_num_plays( void * png_ptr, void * info_ptr );", "	( png_ptr info_ptr -- )" );
	swigFunction( "c-function png_get_next_frame_fcTL png_get_next_frame_fcTL a a a a a a a a a a -- u", "FUNCTION: png_get_next_frame_fcTL ( png_ptr info_ptr width height x_offset y_offset delay_num delay_den dispose_op blend_op -- u )", "EXTERN: \"C\" int png_get_next_frame_fcTL( void * png_ptr, void * info_ptr, void * width, void * height, void * x_offset, void * y_offset, void * delay_num, void * delay_den, void * dispose_op, void * blend_op );", "	( png_ptr info_ptr width height x_offset y_offset delay_num delay_den dispose_op blend_op -- )" );
	swigFunction( "c-function png_set_next_frame_fcTL png_set_next_frame_fcTL a a u u u u u u u u -- u", "FUNCTION: png_set_next_frame_fcTL ( png_ptr info_ptr width height x_offset y_offset delay_num delay_den dispose_op blend_op -- u )", "EXTERN: \"C\" int png_set_next_frame_fcTL( void * png_ptr, void * info_ptr, int width, int height, int x_offset, int y_offset, short delay_num, short delay_den, char dispose_op, char blend_op );", "	( png_ptr info_ptr width height x_offset y_offset delay_num delay_den dispose_op blend_op -- )" );
	swigFunction( "c-function png_get_next_frame_width png_get_next_frame_width a a -- u", "FUNCTION: png_get_next_frame_width ( png_ptr info_ptr -- u )", "EXTERN: \"C\" int png_get_next_frame_width( void * png_ptr, void * info_ptr );", "	( png_ptr info_ptr -- )" );
	swigFunction( "c-function png_get_next_frame_height png_get_next_frame_height a a -- u", "FUNCTION: png_get_next_frame_height ( png_ptr info_ptr -- u )", "EXTERN: \"C\" int png_get_next_frame_height( void * png_ptr, void * info_ptr );", "	( png_ptr info_ptr -- )" );
	swigFunction( "c-function png_get_next_frame_x_offset png_get_next_frame_x_offset a a -- u", "FUNCTION: png_get_next_frame_x_offset ( png_ptr info_ptr -- u )", "EXTERN: \"C\" int png_get_next_frame_x_offset( void * png_ptr, void * info_ptr );", "	( png_ptr info_ptr -- )" );
	swigFunction( "c-function png_get_next_frame_y_offset png_get_next_frame_y_offset a a -- u", "FUNCTION: png_get_next_frame_y_offset ( png_ptr info_ptr -- u )", "EXTERN: \"C\" int png_get_next_frame_y_offset( void * png_ptr, void * info_ptr );", "	( png_ptr info_ptr -- )" );
	swigFunction( "c-function png_get_next_frame_delay_num png_get_next_frame_delay_num a a -- u", "FUNCTION: png_get_next_frame_delay_num ( png_ptr info_ptr -- u )", "EXTERN: \"C\" short png_get_next_frame_delay_num( void * png_ptr, void * info_ptr );", "	( png_ptr info_ptr -- )" );
	swigFunction( "c-function png_get_next_frame_delay_den png_get_next_frame_delay_den a a -- u", "FUNCTION: png_get_next_frame_delay_den ( png_ptr info_ptr -- u )", "EXTERN: \"C\" short png_get_next_frame_delay_den( void * png_ptr, void * info_ptr );", "	( png_ptr info_ptr -- )" );
	swigFunction( "c-function png_get_next_frame_dispose_op png_get_next_frame_dispose_op a a -- u", "FUNCTION: png_get_next_frame_dispose_op ( png_ptr info_ptr -- u )", "EXTERN: \"C\" char png_get_next_frame_dispose_op( void * png_ptr, void * info_ptr );", "	( png_ptr info_ptr -- )" );
	swigFunction( "c-function png_get_next_frame_blend_op png_get_next_frame_blend_op a a -- u", "FUNCTION: png_get_next_frame_blend_op ( png_ptr info_ptr -- u )", "EXTERN: \"C\" char png_get_next_frame_blend_op( void * png_ptr, void * info_ptr );", "	( png_ptr info_ptr -- )" );
	swigFunction( "c-function png_get_first_frame_is_hidden png_get_first_frame_is_hidden a a -- u", "FUNCTION: png_get_first_frame_is_hidden ( png_ptr info_ptr -- u )", "EXTERN: \"C\" char png_get_first_frame_is_hidden( void * png_ptr, void * info_ptr );", "	( png_ptr info_ptr -- )" );
	swigFunction( "c-function png_set_first_frame_is_hidden png_set_first_frame_is_hidden a a u -- u", "FUNCTION: png_set_first_frame_is_hidden ( png_ptr info_ptr is_hidden -- u )", "EXTERN: \"C\" int png_set_first_frame_is_hidden( void * png_ptr, void * info_ptr, char is_hidden );", "	( png_ptr info_ptr is_hidden -- )" );
	swigFunction( "c-function png_read_frame_head png_read_frame_head a a -- void", "FUNCTION: png_read_frame_head ( png_ptr info_ptr -- void )", "EXTERN: \"C\" void png_read_frame_head( void * png_ptr, void * info_ptr );", "	( png_ptr info_ptr -- )" );
	swigFunction( "c-function png_write_frame_head png_write_frame_head a a a u u u u u u u u -- void", "FUNCTION: png_write_frame_head ( png_ptr info_ptr row_pointers width height x_offset y_offset delay_num delay_den dispose_op blend_op -- void )", "EXTERN: \"C\" void png_write_frame_head( void * png_ptr, void * info_ptr, void * row_pointers, int width, int height, int x_offset, int y_offset, short delay_num, short delay_den, char dispose_op, char blend_op );", "	( png_ptr info_ptr row_pointers width height x_offset y_offset delay_num delay_den dispose_op blend_op -- )" );
	swigFunction( "c-function png_write_frame_tail png_write_frame_tail a a -- void", "FUNCTION: png_write_frame_tail ( png_ptr info_ptr -- void )", "EXTERN: \"C\" void png_write_frame_tail( void * png_ptr, void * info_ptr );", "	( png_ptr info_ptr -- )" );
