...
typedef union {
  gpointer p; 
	...
	swigIntConstant( G_MAIN_CONTEXT_FLAGS_NONE, "G_MAIN_CONTEXT_FLAGS_NONE" );
	swigIntConstant( G_MAIN_CONTEXT_FLAGS_OWNERLESS_POLLING, "G_MAIN_CONTEXT_FLAGS_OWNERLESS_POLLING" );
	...
	swigIntConstant( G_TYPE_FLAG_FINAL, "G_TYPE_FLAG_FINAL" );
	...
	swigIntConstant( G_SIGNAL_ACCUMULATOR_FIRST_RUN, "G_SIGNAL_ACCUMULATOR_FIRST_RUN" );
	...
	swigStructField( "_GObject-ref_count", offsetof( struct _GObject, ref_count ), sizeof( guint ) );
	...
	if(offsetof(struct _GSourceCallbackFuncs, ref) >= 0) swigFunctionPointer( "c-funptr _GSourceCallbackFuncs-ref() {((struct _GSourceCallbackFuncs*)ptr)->ref} a -- void", "", "", "	( cb_data -- )" );
	if(offsetof(struct _GSourceCallbackFuncs, unref) >= 0) swigFunctionPointer( "c-funptr _GSourceCallbackFuncs-unref() {((struct _GSourceCallbackFuncs*)ptr)->unref} a -- void", "", "", "	( cb_data -- )" );
	if(offsetof(struct _GSourceCallbackFuncs, get) >= 0) swigFunctionPointer( "c-funptr _GSourceCallbackFuncs-get() {((struct _GSourceCallbackFuncs*)ptr)->get} a a a a -- void", "", "", "	( cb_data source func data -- )" );
	if(offsetof(struct _GSourceFuncs, prepare) >= 0) swigFunctionPointer( "c-funptr _GSourceFuncs-prepare() {((struct _GSourceFuncs*)ptr)->prepare} a a -- n", "", "", "	( source timeout_ -- )" );
	if(offsetof(struct _GSourceFuncs, check) >= 0) swigFunctionPointer( "c-funptr _GSourceFuncs-check() {((struct _GSourceFuncs*)ptr)->check} a -- n", "", "", "	( source -- )" );
	if(offsetof(struct _GSourceFuncs, dispatch) >= 0) swigFunctionPointer( "c-funptr _GSourceFuncs-dispatch() {((struct _GSourceFuncs*)ptr)->dispatch} a a a -- n", "", "", "	( source callback user_data -- )" );
	if(offsetof(struct _GSourceFuncs, finalize) >= 0) swigFunctionPointer( "c-funptr _GSourceFuncs-finalize() {((struct _GSourceFuncs*)ptr)->finalize} a -- void", "", "", "	( source -- )" );
	if(offsetof(struct _GTypeValueTable, value_init) >= 0) swigFunctionPointer( "c-funptr _GTypeValueTable-value_init() {((struct _GTypeValueTable*)ptr)->value_init} a -- void", "", "", "	( value -- )" );
	if(offsetof(struct _GTypeValueTable, value_free) >= 0) swigFunctionPointer( "c-funptr _GTypeValueTable-value_free() {((struct _GTypeValueTable*)ptr)->value_free} a -- void", "", "", "	( value -- )" );
	if(offsetof(struct _GTypeValueTable, value_copy) >= 0) swigFunctionPointer( "c-funptr _GTypeValueTable-value_copy() {((struct _GTypeValueTable*)ptr)->value_copy} a a -- void", "", "", "	( src_value dest_value -- )" );
	if(offsetof(struct _GTypeValueTable, value_peek_pointer) >= 0) swigFunctionPointer( "c-funptr _GTypeValueTable-value_peek_pointer() {((struct _GTypeValueTable*)ptr)->value_peek_pointer} a -- a", "", "", "	( value -- )" );
	if(offsetof(struct _GTypeValueTable, collect_value) >= 0) swigFunctionPointer( "c-funptr _GTypeValueTable-collect_value() {((struct _GTypeValueTable*)ptr)->collect_value} a u a u -- a", "", "", "	( value n_collect_values collect_values collect_flags -- )" );
	if(offsetof(struct _GTypeValueTable, lcopy_value) >= 0) swigFunctionPointer( "c-funptr _GTypeValueTable-lcopy_value() {((struct _GTypeValueTable*)ptr)->lcopy_value} a u a u -- a", "", "", "	( value n_collect_values collect_values collect_flags -- )" );
	if(offsetof(struct _GObjectClass, constructor) >= 0) swigFunctionPointer( "c-funptr _GObjectClass-constructor() {((struct _GObjectClass*)ptr)->constructor} n u a -- a", "", "", "	( type n_construct_properties construct_properties -- )" );
	if(offsetof(struct _GObjectClass, set_property) >= 0) swigFunctionPointer( "c-funptr _GObjectClass-set_property() {((struct _GObjectClass*)ptr)->set_property} a u a a -- void", "", "", "	( object property_id value pspec -- )" );
	if(offsetof(struct _GObjectClass, get_property) >= 0) swigFunctionPointer( "c-funptr _GObjectClass-get_property() {((struct _GObjectClass*)ptr)->get_property} a u a a -- void", "", "", "	( object property_id value pspec -- )" );
	if(offsetof(struct _GObjectClass, dispose) >= 0) swigFunctionPointer( "c-funptr _GObjectClass-dispose() {((struct _GObjectClass*)ptr)->dispose} a -- void", "", "", "	( object -- )" );
	if(offsetof(struct _GObjectClass, finalize) >= 0) swigFunctionPointer( "c-funptr _GObjectClass-finalize() {((struct _GObjectClass*)ptr)->finalize} a -- void", "", "", "	( object -- )" );
	if(offsetof(struct _GObjectClass, dispatch_properties_changed) >= 0) swigFunctionPointer( "c-funptr _GObjectClass-dispatch_properties_changed() {((struct _GObjectClass*)ptr)->dispatch_properties_changed} a u a -- void", "", "", "	( object n_pspecs pspecs -- )" );
	if(offsetof(struct _GObjectClass, notify) >= 0) swigFunctionPointer( "c-funptr _GObjectClass-notify() {((struct _GObjectClass*)ptr)->notify} a a -- void", "", "", "	( object pspec -- )" );
	if(offsetof(struct _GObjectClass, constructed) >= 0) swigFunctionPointer( "c-funptr _GObjectClass-constructed() {((struct _GObjectClass*)ptr)->constructed} a -- void", "", "", "	( object -- )" );
	...
	swigCallback( "c-callback GChildWatchFunc: n n a -- void", "", "", "	( pid wait_status user_data -- )" );
	...
	swigFunction( "c-function _GLIB_CHECKED_ADD_UINT _GLIB_CHECKED_ADD_UINT a u u -- n", "FUNCTION: _GLIB_CHECKED_ADD_UINT ( dest a b -- n )", "EXTERN: \"C\" int _GLIB_CHECKED_ADD_UINT( void * dest, int a, int b );", "	( dest a b -- )" );
	swigFunction( "c-function _GLIB_CHECKED_MUL_UINT _GLIB_CHECKED_MUL_UINT a u u -- n", "FUNCTION: _GLIB_CHECKED_MUL_UINT ( dest a b -- n )", "EXTERN: \"C\" int _GLIB_CHECKED_MUL_UINT( void * dest, int a, int b );", "	( dest a b -- )" );
	swigFunction( "c-function _GLIB_CHECKED_ADD_UINT64 _GLIB_CHECKED_ADD_UINT64 a n n -- n", "FUNCTION: _GLIB_CHECKED_ADD_UINT64 ( dest a b -- n )", "EXTERN: \"C\" int _GLIB_CHECKED_ADD_UINT64( void * dest, n a, n b );", "	( dest a b -- )" );
	swigFunction( "c-function _GLIB_CHECKED_MUL_UINT64 _GLIB_CHECKED_MUL_UINT64 a n n -- n", "FUNCTION: _GLIB_CHECKED_MUL_UINT64 ( dest a b -- n )", "EXTERN: \"C\" int _GLIB_CHECKED_MUL_UINT64( void * dest, n a, n b );", "	( dest a b -- )" );
	swigFunction( "c-function _GLIB_CHECKED_ADD_SIZE _GLIB_CHECKED_ADD_SIZE a n n -- n", "FUNCTION: _GLIB_CHECKED_ADD_SIZE ( dest a b -- n )", "EXTERN: \"C\" int _GLIB_CHECKED_ADD_SIZE( void * dest, n a, n b );", "	( dest a b -- )" );
	swigFunction( "c-function _GLIB_CHECKED_MUL_SIZE _GLIB_CHECKED_MUL_SIZE a n n -- n", "FUNCTION: _GLIB_CHECKED_MUL_SIZE ( dest a b -- n )", "EXTERN: \"C\" int _GLIB_CHECKED_MUL_SIZE( void * dest, n a, n b );", "	( dest a b -- )" );
	...
	swigFunction( "c-function g_main_context_new_with_flags g_main_context_new_with_flags n -- a", "FUNCTION: g_main_context_new_with_flags ( flags -- a )", "EXTERN: \"C\" void * g_main_context_new_with_flags( int flags );", "	( flags -- )" );
	...
	swigFunction( "c-function g_source_set_static_name g_source_set_static_name a s -- void", "FUNCTION: g_source_set_static_name ( source name -- void )", "EXTERN: \"C\" void g_source_set_static_name( void * source, char * name );", "	( source name -- )" );
	...
	swigFunction( "c-function g_steal_fd g_steal_fd a -- n", "FUNCTION: g_steal_fd ( fd_ptr -- n )", "EXTERN: \"C\" int g_steal_fd( void * fd_ptr );", "	( fd_ptr -- )" );
	...
	swigFunction( "c-function g_type_interface_instantiatable_prerequisite g_type_interface_instantiatable_prerequisite n -- n", "FUNCTION: g_type_interface_instantiatable_prerequisite ( interface_type -- n )", "EXTERN: \"C\" n g_type_interface_instantiatable_prerequisite( n interface_type );", "	( interface_type -- )" );
	...
	swigFunction( "c-function g_object_take_ref g_object_take_ref a -- a", "FUNCTION: g_object_take_ref ( object -- a )", "EXTERN: \"C\" void * g_object_take_ref( void * object );", "	( object -- )" );
	...
	swigFunction( "c-function g_signal_is_valid_name g_signal_is_valid_name s -- n", "FUNCTION: g_signal_is_valid_name ( name -- n )", "EXTERN: \"C\" int g_signal_is_valid_name( char * name );", "	( name -- )" );
