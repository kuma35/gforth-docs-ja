...
int main( int argc, char **argv )
{
	...
	swigComment("----===< int constants >===-----\n");
		...
		swigIntConstant( GLX_NV_float_buffer, "GLX_NV_float_buffer" );
	#endif
	#ifdef GLX_FLOAT_COMPONENTS_NV
		swigIntConstant( GLX_FLOAT_COMPONENTS_NV, "GLX_FLOAT_COMPONENTS_NV" );
	#endif
		...
		swigIntConstant( GLX_EXT_texture_from_pixmap, "GLX_EXT_texture_from_pixmap" );
	#endif
	#ifdef GLX_BIND_TO_TEXTURE_RGB_EXT
		swigIntConstant( GLX_BIND_TO_TEXTURE_RGB_EXT, "GLX_BIND_TO_TEXTURE_RGB_EXT" );
	#endif
	#ifdef GLX_BIND_TO_TEXTURE_RGBA_EXT
		swigIntConstant( GLX_BIND_TO_TEXTURE_RGBA_EXT, "GLX_BIND_TO_TEXTURE_RGBA_EXT" );
	#endif
	#ifdef GLX_BIND_TO_MIPMAP_TEXTURE_EXT
		swigIntConstant( GLX_BIND_TO_MIPMAP_TEXTURE_EXT, "GLX_BIND_TO_MIPMAP_TEXTURE_EXT" );
	#endif
	#ifdef GLX_BIND_TO_TEXTURE_TARGETS_EXT
		swigIntConstant( GLX_BIND_TO_TEXTURE_TARGETS_EXT, "GLX_BIND_TO_TEXTURE_TARGETS_EXT" );
	#endif
	#ifdef GLX_Y_INVERTED_EXT
		swigIntConstant( GLX_Y_INVERTED_EXT, "GLX_Y_INVERTED_EXT" );
	#endif
	#ifdef GLX_TEXTURE_FORMAT_EXT
		swigIntConstant( GLX_TEXTURE_FORMAT_EXT, "GLX_TEXTURE_FORMAT_EXT" );
	#endif
	#ifdef GLX_TEXTURE_TARGET_EXT
		swigIntConstant( GLX_TEXTURE_TARGET_EXT, "GLX_TEXTURE_TARGET_EXT" );
	#endif
	#ifdef GLX_MIPMAP_TEXTURE_EXT
		swigIntConstant( GLX_MIPMAP_TEXTURE_EXT, "GLX_MIPMAP_TEXTURE_EXT" );
	#endif
	#ifdef GLX_TEXTURE_FORMAT_NONE_EXT
		swigIntConstant( GLX_TEXTURE_FORMAT_NONE_EXT, "GLX_TEXTURE_FORMAT_NONE_EXT" );
	#endif
	#ifdef GLX_TEXTURE_FORMAT_RGB_EXT
		swigIntConstant( GLX_TEXTURE_FORMAT_RGB_EXT, "GLX_TEXTURE_FORMAT_RGB_EXT" );
	#endif
	#ifdef GLX_TEXTURE_FORMAT_RGBA_EXT
		swigIntConstant( GLX_TEXTURE_FORMAT_RGBA_EXT, "GLX_TEXTURE_FORMAT_RGBA_EXT" );
	#endif
	#ifdef GLX_TEXTURE_1D_BIT_EXT
		swigIntConstant( GLX_TEXTURE_1D_BIT_EXT, "GLX_TEXTURE_1D_BIT_EXT" );
	#endif
	#ifdef GLX_TEXTURE_2D_BIT_EXT
		swigIntConstant( GLX_TEXTURE_2D_BIT_EXT, "GLX_TEXTURE_2D_BIT_EXT" );
	#endif
	#ifdef GLX_TEXTURE_RECTANGLE_BIT_EXT
		swigIntConstant( GLX_TEXTURE_RECTANGLE_BIT_EXT, "GLX_TEXTURE_RECTANGLE_BIT_EXT" );
	#endif
	#ifdef GLX_TEXTURE_1D_EXT
		swigIntConstant( GLX_TEXTURE_1D_EXT, "GLX_TEXTURE_1D_EXT" );
	#endif
	#ifdef GLX_TEXTURE_2D_EXT
		swigIntConstant( GLX_TEXTURE_2D_EXT, "GLX_TEXTURE_2D_EXT" );
	#endif
	#ifdef GLX_TEXTURE_RECTANGLE_EXT
		swigIntConstant( GLX_TEXTURE_RECTANGLE_EXT, "GLX_TEXTURE_RECTANGLE_EXT" );
	#endif
	#ifdef GLX_FRONT_LEFT_EXT
		swigIntConstant( GLX_FRONT_LEFT_EXT, "GLX_FRONT_LEFT_EXT" );
	#endif
	#ifdef GLX_FRONT_RIGHT_EXT
		swigIntConstant( GLX_FRONT_RIGHT_EXT, "GLX_FRONT_RIGHT_EXT" );
	#endif
	#ifdef GLX_BACK_LEFT_EXT
		swigIntConstant( GLX_BACK_LEFT_EXT, "GLX_BACK_LEFT_EXT" );
	#endif
	#ifdef GLX_BACK_RIGHT_EXT
		swigIntConstant( GLX_BACK_RIGHT_EXT, "GLX_BACK_RIGHT_EXT" );
	#endif
	#ifdef GLX_FRONT_EXT
		swigIntConstant( GLX_FRONT_EXT, "GLX_FRONT_EXT" );
	#endif
	#ifdef GLX_BACK_EXT
		swigIntConstant( GLX_BACK_EXT, "GLX_BACK_EXT" );
	#endif
	#ifdef GLX_AUX0_EXT
		swigIntConstant( GLX_AUX0_EXT, "GLX_AUX0_EXT" );
	#endif
	#ifdef GLX_AUX1_EXT
		swigIntConstant( GLX_AUX1_EXT, "GLX_AUX1_EXT" );
	#endif
	#ifdef GLX_AUX2_EXT
		swigIntConstant( GLX_AUX2_EXT, "GLX_AUX2_EXT" );
	#endif
	#ifdef GLX_AUX3_EXT
		swigIntConstant( GLX_AUX3_EXT, "GLX_AUX3_EXT" );
	#endif
	#ifdef GLX_AUX4_EXT
		swigIntConstant( GLX_AUX4_EXT, "GLX_AUX4_EXT" );
	#endif
	#ifdef GLX_AUX5_EXT
		swigIntConstant( GLX_AUX5_EXT, "GLX_AUX5_EXT" );
	#endif
	#ifdef GLX_AUX6_EXT
		swigIntConstant( GLX_AUX6_EXT, "GLX_AUX6_EXT" );
	#endif
	#ifdef GLX_AUX7_EXT
		swigIntConstant( GLX_AUX7_EXT, "GLX_AUX7_EXT" );
	#endif
	#ifdef GLX_AUX8_EXT
		swigIntConstant( GLX_AUX8_EXT, "GLX_AUX8_EXT" );
	#endif
	#ifdef GLX_AUX9_EXT
		swigIntConstant( GLX_AUX9_EXT, "GLX_AUX9_EXT" );
	#endif
	...
	swigStructField( "GLXBufferSwapComplete-drawable", offsetof( GLXBufferSwapComplete, drawable ), sizeof( GLXDrawable ) );
	...
	swigFunction( "c-function glXBindTexImageEXT glXBindTexImageEXT a n n a -- void", "FUNCTION: glXBindTexImageEXT ( dpy drawable buffer attrib_list -- void )", "EXTERN: \"C\" void glXBindTexImageEXT( void * dpy, int drawable, int buffer, void * attrib_list );", "	( dpy drawable buffer attrib_list -- )" );
	swigFunction( "c-function glXReleaseTexImageEXT glXReleaseTexImageEXT a n n -- void", "FUNCTION: glXReleaseTexImageEXT ( dpy drawable buffer -- void )", "EXTERN: \"C\" void glXReleaseTexImageEXT( void * dpy, int drawable, int buffer );", "	( dpy drawable buffer -- )" );
